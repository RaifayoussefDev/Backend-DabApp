...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE trainer_bookings MODIFY COLUMN status ENUM('pending','confirmed','in_progress','completed','cancelled','rejected') NOT NULL DEFAULT 'pending'");
    }
};
