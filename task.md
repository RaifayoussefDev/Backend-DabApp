...
- [x] Check logo existence `public/LogoDabApp.png` <!-- id: 0 -->
- [x] Update `public/admin/guide-admin.html` <!-- id: 1 -->
    - [x] Add `LogoDabApp.png` to sidebar <!-- id: 2 -->
    - [x] Implement `localStorage` for Token & URL (Auto-auth) <!-- id: 3 -->
