...
Route::get('/listings/recent', [ListingController::class, 'getRecentListings']);
...
// ============================================
// PAYTABS CALLBACKS (PUBLIC - WEBHOOK)
// ============================================
...
Route::middleware('auth:api')->group(function () {
    ...
    // ============================================
    // LISTINGS MANAGEMENT (AUTHENTICATED)
    // ============================================
